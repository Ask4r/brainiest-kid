 ...
 */
export function ChartLegendContent({ reversed, payload, align, layout, className }: LegendContentProps & { reversed?: boolean, className?: string }) {
...
export function ChartTooltipContent({ active, payload, label, isRadialChart, isPieChart, formatter, labelFormatter }: ChartTooltipContentProps) {
...
export function ChartActiveDot({ cx = 0, cy = 0 }: ChartActiveDotProps) {
    const size = 12;
