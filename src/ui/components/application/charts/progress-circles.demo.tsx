...
export function ProgressCircle({ size = "sm", title, subtitle }: { size?: "xs" | "sm" | "md" | "lg"; title?: string; subtitle?: string }) {
  const sizes = {
    // collapse-start
    xs: {
      size: 16,
...
export function ProgressCircleXs() {
  return <ProgressCircle size="xs" title="40%" subtitle="Active users" />;
}
export function ProgressCircleSm() {
  return <ProgressCircle title="40%" subtitle="Active users" />;
}
export function ProgressCircleMd() {
  return <ProgressCircle size="md" title="40%" subtitle="Active users" />;
}
export function ProgressCircleLg() {
  return <ProgressCircle size="lg" title="40%" subtitle="Active users" />;
}
export function ProgressCircleXsOnlyTitle() {
  return <ProgressCircle size="xs" title="40%" />;
}
export function ProgressCircleSmOnlyTitle() {
  return <ProgressCircle size="sm" title="40%" />;
}
export function ProgressCircleMdOnlyTitle() {
  return <ProgressCircle size="md" title="40%" />;
}
export function ProgressCircleLgOnlyTitle() {
  return <ProgressCircle size="lg" title="40%" />;
}
