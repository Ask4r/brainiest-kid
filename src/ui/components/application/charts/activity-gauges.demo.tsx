...
import { ChartLegendContent, ChartTooltipContent } from "@/ui/components/application/charts/charts-base";
...
export function ActivityGaugeXs({ title = "1,000", subtitle = "Active users", data = radialData }: ActivityGaugeProps) {
  return (
...
export function ActivityGaugeSm({ title = "1,000", subtitle = "Active users", data = radialData }: ActivityGaugeProps) {
  return (
...
export function ActivityGaugeMd({ title = "1,000", subtitle = "Active users", data = radialData }: ActivityGaugeProps) {
  return (
...
export function ActivityGaugeLg({ title = "1,000", subtitle = "Active users", data = radialData }: ActivityGaugeProps) {
  return (
