...
export function ActivityGauge({ size = "sm", title = "1,000", subtitle = "Active users", data = radialData }: ActivityGaugeProps) {
    return (
...
export function ActivityGaugeXs() {
    return <ActivityGauge size="xs" />;
}
export function ActivityGaugeSm() {
    return <ActivityGauge size="sm" />;
}
export function ActivityGaugeMd() {
    return <ActivityGauge size="md" />;
}
export function ActivityGaugeLg() {
    return <ActivityGauge size="lg" />;
}
