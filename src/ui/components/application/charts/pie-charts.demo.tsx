...
export function PieChartXxs({ data = pieChartData }: PieChartProps) {
  return (
...
export function PieChartXs({ data = pieChartData }: PieChartProps) {
  return (
...
export function PieChartSm({ data = pieChartData }: PieChartProps) {
  return (
...
export function PieChartMd({ data = pieChartData }: PieChartProps) {
  return (
...
export function PieChartLg({ data = pieChartData }: PieChartProps) {
  return (
