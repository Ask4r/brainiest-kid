...
export function TabList<T extends Orientation>({
  size = "sm",
  type = "button-brand",
...
export function Tab({ label, children, badge, icon: Icon, className, ...otherProps }: TabComponentProps) {
...
export function Tabs({ className, ...props }: ComponentPropsWithRef<typeof AriaTabs>) {
  return (
    <AriaTabs
