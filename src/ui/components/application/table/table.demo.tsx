...
import { PaginationCardMinimal, PaginationPageMinimalCenter } from "@/ui/components/application/pagination/pagination";
import customers from "@/ui/components/application/table/customers.json";
import invoices from "@/ui/components/application/table/invoices.json";
import { Table, TableCard, TableRowActionsDropdown } from "@/ui/components/application/table/table";
import teamMembers from "@/ui/components/application/table/team-members.json";
import uploadedFiles from "@/ui/components/application/table/uploaded-files.json";
import { Avatar } from "@/ui/components/base/avatar/avatar";
import type { BadgeTypes } from "@/ui/components/base/badges/badge-types";
import { Badge, type BadgeColor, BadgeWithDot, BadgeWithIcon } from "@/ui/components/base/badges/badges";
