...
export function CalendarDemo() {
  return <Calendar aria-label="Calendar" />;
}

export function CalendarCardDemo() {
  return <AriaDatePicker aria-label="Calendar card" defaultValue={now}>
...
export function DatePickerDemo() {
  return <DatePicker aria-label="Date picker" defaultValue={now} />;
}
