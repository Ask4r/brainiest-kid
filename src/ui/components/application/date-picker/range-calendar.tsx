...
export function RangePresetButton({ value, className, children, ...props }: RangePresetButtonProps) {
...
function MobilePresetButton({ value, children, ...props }: HTMLAttributes<HTMLButtonElement> & { value: { start: DateValue; end: DateValue } }) {
  const context = useContext(RangeCalendarStateContext);
...
export function RangeCalendar({ presets, visibleDuration, showOutOfRangeDates = false, showPresetsOnDesktop = false, ...props }: RangeCalendarProps) {
