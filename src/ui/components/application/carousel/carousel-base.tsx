...
function CarouselRoot({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }: ComponentPropsWithRef<"div"> & CarouselProps) {
...
function CarouselIndicator({ index, isSelected = false, children, asChild, className, style }: CarouselIndicatorProps) {
