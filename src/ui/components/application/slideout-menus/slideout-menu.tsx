...
function Menu({ children, dialogClassName, ...props }: SlideoutMenuProps) {
  return (
    <ModalOverlay {...props}>
...
function Content({ role = "main", ...props }: ComponentPropsWithRef<"div">) {
...
function Header({ className, children, onClose, ...props }: SlideoutHeaderProps) {
  return (
