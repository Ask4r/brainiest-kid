...
import { FeaturedCardProgressBar, FeaturedCardProgressCircle } from "@/ui/components/application/app-navigation/base-components/featured-cards.demo";
import type { NavItemDividerType, NavItemType } from "@/ui/components/application/app-navigation/config";
import { SidebarNavigationDualTier } from "@/ui/components/application/app-navigation/sidebar-navigation/sidebar-dual-tier";
import { SidebarNavigationSectionDividers } from "@/ui/components/application/app-navigation/sidebar-navigation/sidebar-section-dividers";
import { SidebarNavigationSectionsSubheadings } from "@/ui/components/application/app-navigation/sidebar-navigation/sidebar-sections-subheadings";
import { SidebarNavigationSimple } from "@/ui/components/application/app-navigation/sidebar-navigation/sidebar-simple";
import { SidebarNavigationSlim } from "@/ui/components/application/app-navigation/sidebar-navigation/sidebar-slim";
import { Avatar } from "@/ui/components/base/avatar/avatar";
import { Badge, BadgeWithDot } from "@/ui/components/base/badges/badges";
...
export function SidebarNavigationSimpleDemo() {
  return <SidebarNavigationSimple
...
export function SidebarNavigationDualTierDemo() {
  return <SidebarNavigationDualTier
...
export function SidebarSectionDividersDemo() {
  return <SidebarNavigationSectionDividers activeUrl="/" items={navItemsWithDividers} />;
}

export function SidebarNavigationSectionsSubheadingsDemo() {
  return <SidebarNavigationSectionsSubheadings activeUrl="/" items={navItemsWithSectionsSubheadings} />;
}
