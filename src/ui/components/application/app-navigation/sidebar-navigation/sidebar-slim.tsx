...
import { UntitledLogo } from "@/ui/components/foundations/logo/untitledui-logo";
import { UntitledLogoMinimal } from "@/ui/components/foundations/logo/untitledui-logo-minimal";
...
export function SidebarNavigationSlim({ activeUrl, items, footerItems = [], hideBorder, hideRightBorder }: SidebarNavigationSlimProps) {
