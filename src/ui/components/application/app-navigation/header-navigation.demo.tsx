...
import { NavButton } from "@/ui/components/application/app-navigation/base-components/nav-button";
import { HeaderNavigationBase } from "@/ui/components/application/app-navigation/header-navigation";
...
export function HeaderNavigationSimpleDemo() {
  return <HeaderNavigationBase activeUrl="/dashboard" items={simpleItems} />;
}

export function HeaderNavigationDualTierDemo() {
  return <HeaderNavigationBase
    activeUrl="/dashboard"
    items={items}
    actions={
      <>
