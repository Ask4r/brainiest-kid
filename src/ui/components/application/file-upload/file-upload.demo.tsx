...
import { FileUpload, getReadableFileSize } from "@/ui/components/application/file-upload/file-upload-base";
...
export function ImagesOnlyDemo() {
...
export function MaxSizeLimitDemo() {
    const [uploadedFiles, setUploadedFiles] = useState<UploadedFile[]>([]);
...
export function FileUploadProgressBar(props: { isDisabled?: boolean }) {
...
export function FileUploadProgressFill(props: { isDisabled?: boolean }) {
    const [uploadedFiles, setUploadedFiles] = useState<UploadedFile[]>(placeholderFiles);
