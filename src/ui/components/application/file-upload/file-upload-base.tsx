...
export function FileListItemProgressBar({ name, size, progress, failed, type, fileIconVariant, onDelete, onRetry, className }: FileListItemProps) {
...
export function FileListItemProgressFill({ name, size, progress, failed, type, fileIconVariant, onDelete, onRetry, className }: FileListItemProps) {
  const isComplete = progress === 100;
...
function FileUploadRoot(props: ComponentPropsWithRef<"div">) {
  return <div {...props} className={cx("flex flex-col gap-4", props.className)}>
    {props.children}
  </div>;
}

function FileUploadList(props: ComponentPropsWithRef<"ul">) {
  return <ul {...props} className={cx("flex flex-col gap-3", props.className)}>
