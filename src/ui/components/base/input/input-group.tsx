...
import type { TextFieldProps } from "@/ui/components/base/input/input";
...
export function InputGroup({ size = "md", prefix, leadingAddon, trailingAddon, label, hint, hideRequiredIndicator, children, ...props }: InputGroupProps) {
