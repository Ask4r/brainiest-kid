...
import type { InputBaseProps } from "@/ui/components/base/input/input";
import { InputBase, TextField } from "@/ui/components/base/input/input";
import { Label } from "@/ui/components/base/input/label";
import { AmexIcon, DiscoverIcon, MastercardIcon, UnionPayIcon, VisaIcon } from "@/ui/components/foundations/payment-icons";
...
export function PaymentInput({ onChange, value, defaultValue, className, maxLength = 19, label, hint, ...props }: PaymentInputProps) {
