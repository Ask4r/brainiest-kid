...
import { Input, InputBase, TextField } from "@/ui/components/base/input/input";
import { InputFile } from "@/ui/components/base/input/input-file";
import { InputGroup } from "@/ui/components/base/input/input-group";
import { PaymentInput } from "@/ui/components/base/input/input-payment";
...
export function LeadingIconDemo() {
  return (
    <Input
      isRequired
      icon={Mail01}
...
export function LeadingDropdownDemo() {
  return (
    <InputGroup
      isRequired
      label="Phone number"
...
export function TrailingDropdownDemo() {
  return (
    <InputGroup
      isRequired
      prefix="$"
...
export function LeadingTextDemo() {
  return (
...
export function PaymentInputDemo() {
  return (
...
export function TrailingButtonDemo() {
...
export function TagInputOuterDemo() {
  return (
    <InputTagsOuter
      isRequired
      label="Tags"
...
export function FileUploadInputDemo({ size = "sm" as "sm" | "md" | "lg" }) {
...
export function FileUploadInputs() {
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-4">
...
export function TagInputsOuter() {
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-4">
        <InputTagsOuter
