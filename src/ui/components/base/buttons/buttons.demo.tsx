...
function Circle(props: HTMLAttributes<HTMLSpanElement>) {
  return <span {...props} className={cx("size-5 rounded-[50%] border-2 border-current", props.className)} />;
}
...
export function PrimaryDestructive() {
  return (
    <div>
      <div className="mb-4 flex gap-8">
...
export function SecondaryDestructive() {
  return (
    <div>
      <div className="mb-4 flex gap-8">
...
export function TertiaryDestructive() {
  return (
    <div>
      <div className="mb-4 flex gap-8">
...
export function LinkDestructive() {
  return (
    <div>
      <div className="mb-4 flex gap-8">
...
export function CloseXLightDemo() {
  return (
...
export function CloseXDarkDemo() {
  return (
    <div className="flex items-start gap-3">
...
export function UtilityButtonDefaultDemo() {
  return (
...
export function UtilityButtonSecondaryDemo() {
  return (
    <div className="flex items-start gap-3">
...
export function UtilityButtonTertiaryDemo() {
  return (
    <div className="flex items-start gap-1">
      <ButtonUtility size="sm" color="tertiary" tooltip="Copy" icon={Copy01} />
      <ButtonUtility size="sm" color="tertiary" tooltip="Download" icon={DownloadCloud02} />
...
export function UtilityButtonDisabledDemo() {
  return (
    <div className="flex items-start gap-3">
...
export function UtilityButtonSizesDemo() {
  return (
