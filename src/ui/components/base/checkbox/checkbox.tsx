...
export function CheckboxBase({ className, isSelected, isDisabled, isIndeterminate, size = "sm", isFocusVisible = false }: CheckboxBaseProps) {
    return (
        <div
            className={cx(
...
export function Checkbox({ label, hint, size = "sm", className, ...ariaCheckboxProps }: CheckboxProps) {
    const sizes = {
        sm: {
            root: "gap-2",
            textWrapper: "",
