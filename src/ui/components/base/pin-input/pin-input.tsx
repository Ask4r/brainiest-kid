...
function Root({ className, size = "md", disabled = false, ...props }: RootProps) {
    const id = useId();
...
function FakeCaret({ size = "md" }: { size?: "sm" | "md" | "lg" }) {
    return (
        <div
            className={cx(
...
function Separator(props: ComponentPropsWithRef<"p">) {
    return (
