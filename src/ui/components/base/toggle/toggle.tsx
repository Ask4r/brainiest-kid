...
export function ToggleBase({ className, isHovered, isDisabled, isFocusVisible, isSelected, slim, size = "sm" }: ToggleBaseProps) {
    const styles = {
        default: {
            sm: {
                root: "h-5 w-9 p-0.5",
...
export function Toggle({ label, hint, className, size = "sm", slim, ...ariaSwitchProps }: ToggleProps) {
    const sizes = {
        sm: {
            root: "gap-2",
            textWrapper: "",
