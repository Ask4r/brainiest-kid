...
import { type SelectItemType, sizes } from "@/ui/components/base/select/select-shared";
...
function InnerTagSelect({ isDisabled, shortcut, shortcutClassName, placeholder, size = "sm" }: Omit<TagSelectProps, "selectedItems" | "children">) {
