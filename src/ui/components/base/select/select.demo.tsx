...
import { Select, type SelectItemType } from "@/ui/components/base/select/select";
...
import { Dot } from "@/ui/components/foundations/dot-icon";
...
export function MultiSelectSmDemo() {
...
export function MultiSelectMdDemo() {
  const [selectedKeys, setSelectedKeys] = useState<Selection>(new Set(["design", "product"]));
...
export function MultiSelectLgDemo() {
  const [selectedKeys, setSelectedKeys] = useState<Selection>(new Set(["design", "product"]));
