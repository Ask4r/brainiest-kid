...
import { type CommonProps, SelectContext, type SelectItemType, sizes } from "@/ui/components/base/select/select";
...
function ComboBoxValue({ size, shortcut, placeholder, shortcutClassName, ...otherProps }: ComboBoxValueProps) {
...
export function ComboBox({ placeholder = "Search", shortcut = true, size = "sm", children, items, shortcutClassName, ...otherProps }: ComboBoxProps) {
