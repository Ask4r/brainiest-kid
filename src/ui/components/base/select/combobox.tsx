...
import { type CommonProps, SelectContext, type SelectItemType, sizes } from "@/ui/components/base/select/select-shared";
...
function ComboBoxValue({ size, shortcut, placeholder, shortcutClassName, icon: IconProp, ...otherProps }: ComboBoxValueProps) {
