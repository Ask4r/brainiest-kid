...
function MultiSelectFooter({ size = "sm", onReset, onSelectAll, className }: MultiSelectFooterProps) {
...
function MultiSelectEmptyState({
  ...
  return <div className={cx("flex flex-col items-center gap-3 px-4 py-4", className)}>
