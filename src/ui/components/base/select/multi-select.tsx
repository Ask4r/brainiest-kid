...
import type { IconComponentType } from "@/ui/components/base/badges/badge-types";
...
import { type SelectItemType, sizes } from "@/ui/components/base/select/select";
import { TagCloseX } from "@/ui/components/base/tags/base-components/tag-close-x";
import { useResizeObserver } from "@/ui/hooks/use-resize-observer";
import { cx } from "@/ui/utils/cx";
import { SelectItem } from "./select-item";
import { isReactComponent } from "@/ui/utils/is-react-component";
                        ...
                        <span key={value.id} className="flex items-center rounded-md bg-primary py-0.5 pr-1 pl-1.25 ring-1 ring-primary ring-inset">
                            {value?.avatarUrl
                                ...
                                : isReactComponent(value?.icon)
                                    ? (
                                        <Icon size={16} color="var(--color-fg-quaternary)" />
                                    )
                            ...
                            <TagCloseX
                                ...
                                onKeyDown={(event: KeyboardEvent<HTMLButtonElement>) => handleTagKeyDown(event, value.id)}
