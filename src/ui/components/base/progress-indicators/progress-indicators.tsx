 ...
 */
export function ProgressBarBase({ value, min = 0, max = 100, className, progressClassName }: ProgressBarProps) {
 ...
 */
export function ProgressBar({ value, min = 0, max = 100, valueFormatter, labelPosition, className, progressClassName }: ProgressIndicatorWithTextProps) {
    const percentage = ((value - min) * 100) / (max - min);
