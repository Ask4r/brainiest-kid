...
import { ProgressBarCircle, ProgressBarHalfCircle } from "@/ui/components/base/progress-indicators/progress-circles";
import { ProgressBar } from "@/ui/components/base/progress-indicators/progress-indicators";

export function ProgressBarDefault() {
  return <ProgressBar min={0} max={100} value={40} />;
}

export function ProgressBarTextRight() {
  return <ProgressBar labelPosition="right" min={0} max={100} value={40} />;
}

export function ProgressBarTextBottom() {
  return <ProgressBar labelPosition="bottom" min={0} max={100} value={40} />;
}

export function ProgressBarTextTopFloating() {
  return <ProgressBar labelPosition="top-floating" min={0} max={100} value={40} />;
}

export function ProgressBarTextBottomFloating() {
  return <ProgressBar labelPosition="bottom-floating" min={0} max={100} value={40} />;
}

export function CircleProgressBar() {
  return <div className="flex flex-col items-start gap-10 md:flex-row">
